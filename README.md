...
The mod "ra's Copy Clothing Colors" for the video game Project Zomboid. See the mod's [workshop page on steam](https://steamcommunity.com/sharedfiles/filedetails/?id=3452206197) for info about the mod's content.
...
Manual installation:
1. Download the .zip file from the [release section](https://github.com/razab87/rasCopyClothingColors/releases/tag/v1.2.1).
